...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 08, 2019 at 02:48 PM
...
CREATE TABLE IF NOT EXISTS `short_competition` (
  ...
  `type_of_sending` enum('email','pošta','email i pošta','direktno') COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `id_competition` (`id_competition`)
